...
public class CategoryRestController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> edit(@Valid @RequestBody CategoryDTO dto) {
    ...
    public ResponseEntity<Category> detail(@PathVariable("id") Long id) {
        Optional<Category> currentData = categoryService.findById(id);
    ...
    public ResponseEntity<Category> delete(@PathVariable("id") Long id) {
        Optional<Category> currentData = categoryService.findById(id);
        if (currentData.isPresent()) {
            categoryService.delete(currentData.get());
