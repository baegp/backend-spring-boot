...
public class AccountServiceImpl implements AccountService {
    ...
    public Account checkUsername(String email) {
        return accountRepository.checkUsername(email);
    }
    ...
    public <S extends Account> Optional<S> findOnewhere(Example<S> example) {
        return accountRepository.findOne(example); // Generated from
                                                   // nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public Optional<Account> findByUserName(String userName) {
        return accountRepository.findByUserName(userName); // Generated from
                                                           // nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
